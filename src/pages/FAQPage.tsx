...
const FAQItem: Component<{ question: string; answer: string }> = (props) => {
  ...
  return (
    <div class="border border-gray-200 rounded-xl overflow-hidden">
      ...
      >
        <span class="font-medium text-gray-900 text-sm sm:text-base pr-3">{props.question}</span>
        <svg
...
const FAQPage: Component = () => {
  ...
  onMount(() => {
    if (heroRef) {
      gsap.fromTo(heroRef, { opacity: 0, y: 30 }, { opacity: 1, y: 0, duration: 0.7, ease: 'power2.out' });
    }
    if (bodyRef) {
      gsap.fromTo(bodyRef, { opacity: 0, y: 20 }, { opacity: 1, y: 0, duration: 0.6, delay: 0.2, ease: 'power2.out' });
    }
  });
      ...
      <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16">
        ...
        <div ref={heroRef} class="text-center mb-12 sm:mb-16">
          ...
          <h1 class="text-3xl sm:text-5xl font-black text-gray-900 mb-4">
            Frequently Asked <span class="bg-gradient-to-r from-main-red to-red-700 bg-clip-text text-transparent">Questions</span>
          </h1>
        ...
        <div ref={bodyRef} class="space-y-10">
          ...
          <section>
            <div class="flex items-center gap-3 mb-5">
              <div class="w-9 h-9 bg-main-red/10 rounded-xl flex items-center justify-center flex-shrink-0">
                <svg class="w-5 h-5 text-main-red" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <h2 class="text-lg sm:text-xl font-bold text-gray-900">General</h2>
            </div>
            <div class="space-y-3">
              <FAQItem
          ...
          <section>
            <div class="flex items-center gap-3 mb-5">
              ...
              <h2 class="text-lg sm:text-xl font-bold text-gray-900">Using QEmail</h2>
            </div>
            <div class="space-y-3">
              <FAQItem
          ...
          <section>
            <div class="flex items-center gap-3 mb-5">
              ...
              <h2 class="text-lg sm:text-xl font-bold text-gray-900">Privacy & Security</h2>
            </div>
            <div class="space-y-3">
              <FAQItem
          ...
          <section>
            <div class="flex items-center gap-3 mb-5">
              ...
              <h2 class="text-lg sm:text-xl font-bold text-gray-900">Inbox & Expiry</h2>
            </div>
            <div class="space-y-3">
              <FAQItem
