            ...
            >
                      ...
                      <div class="flex items-start justify-between gap-4">
                        <div class="flex-1 min-w-0">
                          <div class="flex items-center gap-2 mb-1">
                            {!email.is_read && (
                              <span class="w-2 h-2 bg-main-red rounded-full" />
                            )}
                          ...
                          <p class="text-xs text-main-gray truncate">
                            {email.body_text?.substring(0, 100)}...
                          </p>
                        </div>
                        <span class="text-xs text-main-gray whitespace-nowrap">
              ...
              <Show when={totalPages() > 1}>
                <div class="flex items-center justify-center gap-2 px-6 py-4 border-t border-gray-200">
                  ...
                  <span class="text-sm text-main-gray px-4">
          ...
          <Show when={selectedEmail()}>
            {(email) => (
              <div class="space-y-6">
                <div class="space-y-3">
                  <div>
                    <label class="text-xs font-semibold text-main-gray uppercase tracking-wide">
                      From
                    </label>
