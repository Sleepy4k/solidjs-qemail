          ...
          <Card>
            <div class="flex items-center justify-center py-12">
              <div class="text-center">
                <div class="animate-spin w-10 h-10 border-4 border-main-red border-t-transparent rounded-full mx-auto"></div>
                <p class="mt-4 text-main-gray text-sm">Loading settings...</p>
              </div>
            </div>
          </Card>
        }
                ...
                <div class="px-4 sm:px-6 py-5 hover:bg-gray-50 transition-colors">
                  <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
                    <div class="flex-1 min-w-0">
                      <h3 class="text-xs sm:text-sm font-semibold text-main-red uppercase tracking-wide mb-2">
                        {setting.key}
                      </h3>
                      ...
                      <Show
                        ...
                        fallback={
                          <>
                            <div class="mt-1">
                              <code class="inline-block px-3 py-2 bg-main-lightGray rounded-lg text-xs sm:text-sm font-mono text-gray-900 break-all max-w-full">
                                {setting.value}
                              </code>
                            </div>
                            <p class="mt-2 text-xs text-main-gray">
