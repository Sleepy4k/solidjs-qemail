...
const Alert: Component<AlertProps> = (props) => {
  ...
  onMount(() => {
    if (alertRef) {
      animations.slideInRight(alertRef, { duration: 0.4 });
    }
  });

  onMount(() => {
    if (props.autoDismiss !== false && props.onClose) {
      const delay = props.dismissDelay || 5000;
      setTimeout(() => props.onClose?.(), delay);
    }
  });
